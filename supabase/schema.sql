...
-- Stats dashboard — aggregate-only headline totals. Zero rows if the caller
-- doesn't manage the truck (no data leak); never returns a follows row.
...
-- Weekly time series for the stats mini bar charts, most recent p_weeks weeks.
