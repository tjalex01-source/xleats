...
import type { MenuItem, MenuPhoto, AccountPlan } from '@/lib/types';

const CATEGORIES = ['Appetizers', 'Entrees', 'Breakfast', 'Sides', 'Drinks', 'Desserts', 'Specials', 'Other'];
...
export default function Menu() {
  ...
  async function load() {
    ...
    const [{ data: acc }, { data: allTrucks }, { data: allItems }, { data: menuPhotos }] = await Promise.all([
